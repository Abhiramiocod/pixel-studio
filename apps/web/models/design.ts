/**
 * Reading and updating a design document immutably.
 *
 * The document *schema* lives in `@pixel-studio/types`; this module holds the
 * tree operations the editor performs on it, and stays free of React, canvas
